...
#lables and entries
part_text = StringVar()
part_label = Label(app, text="Part Name", font=("Bold, 14"), pady=20, bg="Grey")
...
customer_label = Label(app, text="Customer", font=("Bold, 14"), bg="Grey")
...
retailer_label = Label(app, text="Retailer", font=("Bold, 14"), pady=20, bg="Grey")
...
price_label = Label(app, text="Price", font=("Bold, 14"), bg="Grey")
...
scrollbar.grid(row=3, column=3, pady=20)
